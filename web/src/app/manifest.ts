...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    theme_color: "#0a0d0c",
    icons: [
      { src: "/icones/highwai-192.png", sizes: "192x192", type: "image/png" },
      { src: "/icones/highwai-512.png", sizes: "512x512", type: "image/png" },
      { src: "/icones/highwai-512-maskable.png", sizes: "512x512", type: "image/png", purpose: "maskable" },
    ],
  };
}
