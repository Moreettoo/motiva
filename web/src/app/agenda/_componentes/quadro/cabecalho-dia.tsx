...
export function CabecalhoDia({
  ...
  /* A tinta secundária desta coluna, e a de ênfase acima dela — esta com TETO
     ...
     tinta: `font-semibold` distingue `N s/ turma` sem mexer em tinta nenhuma, e
  ...
  return (
    ...
    >
      ...
      {/* Os dois `<p>` visíveis são `aria-hidden`, e o `sr-only` mais abaixo é o
          ...
          13" e "8 · 3 s/ turma", telegrafados fora de contexto, antes de
          "quinta-feira, 13 de agosto. 8 serviços com turma, 3 sem turma.".
      ...
      >
        ...
        {/* O `aria-hidden` próprio é redundante hoje (o `<p>` inteiro já está
            oculto) e fica de propósito, como o do ícone abaixo: separador e
            ícone não podem ser falados NUNCA, nem se alguém reabrir o `<p>`. */}
